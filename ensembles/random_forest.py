...
class RandomForestMSE:
    def __init__(
        ...
        Classic ML algorithm that trains a set of independent tall decision
            trees and averages its predictions. Employs scikit-learn
            `DecisionTreeRegressor` under the hood.

        Args:
            n_estimators (int): Number of trees in the forest.
            tree_params (dict[str, Any] | None, optional): Parameters for
            sklearn trees. Defaults to None.
        """
        ...
        self.forest = [DecisionTreeRegressor(**tree_params) for _ in
                       range(n_estimators)]
    ...
    def fit(
        ...
        Args:
            ...
            X_val (npt.NDArray[np.float64] | None, optional): Validation set of
                ...
                to None.
            y_val (npt.NDArray[np.float64] | None, optional): Validation set of
                labels, array of shape (n_val_objects,). Defaults to None.
        ...
        Returns:
            ConvergenceHistory | None: Instance of `ConvergenceHistory` if
                `trace=True` or if validation data is provided.
        """
